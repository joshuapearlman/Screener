...
- Normalized FCF calculated as simple average annual FCF margin × latest annual revenue
- P/nFCF, EV/nFCF, FCF yield, debt, dilution, SBC, and reliability checks
- Visible calculation audit showing revenue, FCF totals, average annual FCF, shares, market cap, debt, cash, and valuation arithmetic
- Median-margin reliability check that blocks automatic ideas when its relative difference from the average exceeds 20%
- Robust annual-margin outlier warnings using median absolute deviation
...
- has P/nFCF at or below 15x;
- has an average-versus-median FCF margin gap of no more than 20%;
- passes market-cap sanity checks and has normalized FCF yield no higher than 50%;
...
Auto Finder valuations use Yahoo's supplied market capitalization. Single-stock and pasted-ticker reports compare SEC instant shares with annual diluted shares; a material mismatch falls back to annual diluted shares and creates a warning instead of silently producing an extreme valuation.
